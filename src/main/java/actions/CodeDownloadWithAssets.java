...
public class CodeDownloadWithAssets extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        Notification startingNotification = flutterFlowGroup.createNotification("Starting FlutterFlow code export with assets", NotificationType.INFORMATION);
        ...
        new Thread(() -> {
            try {
                ...
                Notification successNotification = flutterFlowGroup.createNotification("FlutterFlow code export with assets completed successfully.", NotificationType.INFORMATION);
                Notifications.Bus.notify(successNotification);
            } catch (Exception ex) {
                // Failure notification
                Notification failureNotification = flutterFlowGroup.createNotification("Failed to execute FlutterFlow code export with assets.\n" + ex.getMessage(), NotificationType.ERROR);
